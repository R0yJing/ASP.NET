...
namespace MelanomaClassification.Services
{
    ...
    public class WebClassifierService : IClassifierService
    {
        ...
        "https://australiaeast.api.cognitive.microsoft.com/customvision/v3.0/Prediction/09917653-9816-4ebd-9607-77b22d913077/classify/iterations/Iteration3/image";
        ...
        private static volatile bool Connecting = false;
        ...
        public async Task<bool> TryConnect()
        {
            try
            {
                //if connected, it is supposed to give bad request because the image is null!
                Connecting = true;
                var response = await client.PostAsync(endpointUrl, null);
                Connecting = false;
                return response.StatusCode.ToString().Contains("BadRequest");
